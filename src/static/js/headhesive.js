...
(function (root, factory) {
  ...
  Headhesive.prototype = {
    ...
    init: function () {
      ...
      fakeElem.innerHTML = this.clonedElem.innerHTML;
      fakeElem.setAttribute('aria-hidden', true);
      fakeElem.setAttribute('class', 'pykl-header');
      console.log(fakeElem)
      this.clonedElem = fakeElem;
      console.log(this.clonedElem === fakeElem)
      this.clonedElem.className += ' ' + this.options.classes.clone;
      document.body.insertBefore(this.clonedElem, document.body.firstChild);
      // fakeEl.className += ' ' + this.options.classes.clone;
      // document.body.insertBefore(this.clonedElem, document.body.firstChild);
